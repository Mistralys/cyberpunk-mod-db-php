...
/**
 * Information about the BodyTags tag.
 * 
 ...
 */
class BodyTags extends BaseTagInfo
{
    public const TAG_NAME = 'BodyTags';
    ...
    {
        return 'Vanilla small and big body tags';
    }
    
    public function getCategory(): string
    {
        return 'Mods - Utilities';
    }
    
    protected function _getLinks() : array
    {
        return array(
            new TagLink($this, 'https://www.nexusmods.com/cyberpunk2077/mods/19286', 'Nexus')
        );
    }
}
