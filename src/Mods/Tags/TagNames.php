...
use CPMDB\Mods\Tags\Types\BodyElegy;
...
use CPMDB\Mods\Tags\Types\Helmet;
...
use CPMDB\Mods\Tags\Types\Toggles;
...
class TagNames
{
    ...
    public const BODY_ELEGY = BodyElegy::TAG_NAME;
    ...
    public const HELMET = Helmet::TAG_NAME;
    ...
    public const TOGGLES = Toggles::TAG_NAME;
