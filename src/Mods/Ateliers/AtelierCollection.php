...
use CPMDB\Mods\Ateliers\Atelier\BreezysThriftShopAtelier;
use CPMDB\Mods\Ateliers\Atelier\ComplecteddNecklaceAtelier;
use CPMDB\Mods\Ateliers\Atelier\CorpoClothingAtelier;
...
use CPMDB\Mods\Ateliers\Atelier\FrailIncAtelier;
...
use CPMDB\Mods\Ateliers\Atelier\LilydeltaBoutiquesAtelier;
use CPMDB\Mods\Ateliers\Atelier\MayoVirtualAtelier;
use CPMDB\Mods\Ateliers\Atelier\MelsOnlineCatalogueAtelier;
...
use CPMDB\Mods\Ateliers\Atelier\RaetelierAtelier;
use CPMDB\Mods\Ateliers\Atelier\RosasShopAtelier;
use CPMDB\Mods\Ateliers\Atelier\ScofilVirtualAtelier;
...
use CPMDB\Mods\Ateliers\Atelier\TonysCasualStore;
use CPMDB\Mods\Ateliers\Atelier\TottesAtelier;
use CPMDB\Mods\Ateliers\Atelier\TqmAtelier;
...
use CPMDB\Mods\Ateliers\Atelier\VeegeeShop3Atelier;
...
class AtelierCollection extends BaseStringPrimaryCollection
{
    ...
    protected function registerItems(): void
    {
        ...
        $this->registerItem(new BreezysThriftShopAtelier($this));
        $this->registerItem(new ComplecteddNecklaceAtelier($this));
        $this->registerItem(new CorpoClothingAtelier($this));
        ...
        $this->registerItem(new FrailIncAtelier($this));
        ...
        $this->registerItem(new LilydeltaBoutiquesAtelier($this));
        $this->registerItem(new MayoVirtualAtelier($this));
        $this->registerItem(new MelsOnlineCatalogueAtelier($this));
        ...
        $this->registerItem(new RaetelierAtelier($this));
        $this->registerItem(new RosasShopAtelier($this));
        $this->registerItem(new ScofilVirtualAtelier($this));
        ...
        $this->registerItem(new TonysCasualStore($this));
        $this->registerItem(new TottesAtelier($this));
        $this->registerItem(new TqmAtelier($this));
        ...
        $this->registerItem(new VeegeeShop3Atelier($this));
